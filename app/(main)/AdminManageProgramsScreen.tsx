      ...
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : undefined}>
        <View style={styles.header}>
          ...
          <TouchableOpacity onPress={openCreate} style={styles.headerAdd}>
            <Ionicons name="add" size={23} color={theme.onPrimary} />
          </TouchableOpacity>
        </View>

        <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
          <View style={styles.hero}>
            <View style={styles.heroIcon}><Ionicons name="school-outline" size={26} color={theme.onPrimary} /></View>
            <View style={{ flex: 1 }}>
          ...
          <View style={styles.searchShell}>
            ...
            />
            {!!search && <TouchableOpacity onPress={() => setSearch("")}><Ionicons name="close-circle" size={18} color={theme.textMuted} /></TouchableOpacity>}
          </View>

          <TouchableOpacity style={styles.addButton} onPress={openCreate} activeOpacity={0.84}>
            <Ionicons name="add-circle-outline" size={19} color={theme.onPrimary} />
          ...
          {filteredPrograms.length === 0 ? (
            <View style={styles.emptyCard}>
              <Ionicons name="school-outline" size={42} color={theme.textMuted} />
...
const makeStyles = (c: ThemeTokens) =>
  ...
  headerTitle: { fontSize: 19, fontWeight: "800", color: c.textSecondary },
  headerAdd: { width: 34, height: 34, borderRadius: 17, backgroundColor: c.danger, alignItems: "center", justifyContent: "center" },
  content: { padding: 18, paddingBottom: 55 },
  hero: { flexDirection: "row", alignItems: "center", gap: 13, padding: 17, borderRadius: 18, backgroundColor: c.danger, marginBottom: 14 },
  heroIcon: { width: 46, height: 46, borderRadius: 15, backgroundColor: c.primary, alignItems: "center", justifyContent: "center" },
  heroTitle: { color: c.surface, fontSize: 17, fontWeight: "800" },
  heroText: { color: c.onPrimary, fontSize: 12.5, lineHeight: 18, marginTop: 3 },
  searchShell: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: c.surface, borderWidth: 1, borderColor: c.border, borderRadius: 13, paddingHorizontal: 13, minHeight: 46, marginBottom: 12 },
  searchInput: { flex: 1, color: c.textPrimary, fontSize: 14 },
  addButton: { backgroundColor: c.accent, borderRadius: 13, minHeight: 46, flexDirection: "row", alignItems: "center", justifyContent: "center", gap: 7, marginBottom: 13 },
  addButtonText: { color: c.surface, fontWeight: "800", fontSize: 14 },
  countText: { color: c.textMuted, fontSize: 12, fontWeight: "700", marginBottom: 8 },
  programCard: { backgroundColor: c.surface, borderWidth: 1, borderColor: c.border, borderRadius: 16, padding: 14, marginBottom: 10, flexDirection: "row", alignItems: "center", gap: 11 },
  skeletonCard: { backgroundColor: c.surface, borderWidth: 1, borderColor: c.border, borderRadius: 16, padding: 16, marginBottom: 10 },
  programBadge: { width: 48, height: 48, borderRadius: 14, backgroundColor: c.accentSoft, alignItems: "center", justifyContent: "center" },
  programBadgeText: { color: c.textSecondary, fontWeight: "900", fontSize: 12 },
  programName: { color: c.textPrimary, fontWeight: "800", fontSize: 14.5 },
  programCode: { color: c.accent, fontWeight: "800", fontSize: 12, marginTop: 3 },
  programDescription: { color: c.textMuted, fontSize: 11.5, marginTop: 4 },
  actionRow: { flexDirection: "row", gap: 7 },
  iconButton: { width: 36, height: 36, borderRadius: 11, backgroundColor: c.surfaceSunken, alignItems: "center", justifyContent: "center" },
  deleteIcon: { backgroundColor: c.surfaceSunken },
  emptyCard: { backgroundColor: c.surface, borderWidth: 1, borderColor: c.border, borderRadius: 16, padding: 28, alignItems: "center" },
  emptyTitle: { color: c.textPrimary, fontSize: 16, fontWeight: "800", marginTop: 8 },
  center: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24 },
  title: { fontSize: 22, fontWeight: "800", color: c.textPrimary, marginTop: 12 },
  muted: { color: c.textMuted, textAlign: "center", marginTop: 6, lineHeight: 19 },
  ...
  label: { color: c.textSecondary, fontWeight: "800", marginBottom: 7, marginTop: 10 },
  input: { backgroundColor: c.surface, borderWidth: 1, borderColor: c.border, borderRadius: 13, paddingHorizontal: 14, paddingVertical: 12, color: c.textPrimary, fontSize: 14.5 },
